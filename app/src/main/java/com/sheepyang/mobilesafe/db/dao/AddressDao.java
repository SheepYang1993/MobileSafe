...
/**
 * Created by SheepYang on 2016/6/11 12:50.
 */
public class AddressDao {
    public static String queryAddress(Context context, String phoneNumber){
        String location = "";
            ...
            switch (phoneNumber.length()) {
                ...
                default:// 010 1234567   10位  	010 12345678  11位     0372  12345678  12位
                    ...
                    if (phoneNumber.length() >= 10  &&  phoneNumber.startsWith("0")) {
                        ...
                        //3位,4位
                        //3位
                        String result = phoneNumber.substring(1, 3);//010   10
                        //2.根据区号查询号码归属地
                        ...
                        if (cursor.moveToNext()) {
                            ...
                            //3位没有查询到,直接查询4位
                            //获取4位的区号
                            result = phoneNumber.substring(1, 4);//0372    372
