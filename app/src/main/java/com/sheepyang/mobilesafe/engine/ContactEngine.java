package com.sheepyang.mobilesafe.engine;
...
/**
 * Created by SheepYang on 2016/6/10 12:32.
 */
public class ContactEngine {
    public static List<Contact> getAllContactInfo(Context context) {
        ...
        while (cursor.moveToNext()) {
            ...
            if (!TextUtils.isEmpty(contact_id)) {//null   ""
                ...
                Log.i(Constants.TAG, "getAllContactInfo-----Name:" + contact.getName());
                Log.i(Constants.TAG, "getAllContactInfo-----Phone:" + contact.getPhone());
                // 11.添加到集合中数据
