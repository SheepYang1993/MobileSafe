...
import com.sheepyang.mobilesafe.receiver.MyWidget;
import com.sheepyang.mobilesafe.utils.TaskUtil;
...
public class WidgetService extends Service {
    ...
    public void killProcess() {
        ...
        for (AndroidAppProcess runningAppProcessInfo : runningAppProcesses) {
            //判断我们的应用进程不能被清理
            if (!runningAppProcessInfo.name.equals(getPackageName())) {
                am.killBackgroundProcesses(runningAppProcessInfo.name);
            }
        }
    }
